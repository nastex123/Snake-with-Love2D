...
harness.describe("entities.snake - Movement and Tactical Standstill", function()
    ...
    harness.it("advances automatically in classic mode without keys held", function()
        worldState.set("controlMode", "classic")
        local s = snake.reset()
        ...
        harness.assert_false(s.standstill, "standstill is false in classic mode")
        harness.assert_equal(6, s.body[1].x, "head x advanced from 5 to 6")
    ...
    harness.it("advances 1 tile when input queue has direction", function()
        ...
        harness.assert_equal(6, s.body[1].y, "head moved down from 5 to 6")
        harness.assert_equal(5, s.body[2].x, "segment 2 moved to 5")
        harness.assert_equal(5, s.body[2].y, "segment 2 y is 5")
        harness.assert_equal(4, s.body[3].x, "segment 3 moved to 4")
        harness.assert_equal(5, s.body[3].y, "segment 3 y is 5")
