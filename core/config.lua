...
-- Status Effects Engine (GDD §16): duraciones, umbrales y multiplicadores
config.STATUS_OVERDRIVE_COMBO = 6
config.STATUS_OVERDRIVE_DURATION = 4.0
config.STATUS_OVERDRIVE_SPEED_MULT = 0.8
config.STATUS_MEDUSA_DURATION = 2.0
config.STATUS_VENOM_DURATION = 1.8
config.STATUS_VENOM_SPORE_CHANCE = 0.30
config.STATUS_CRYO_DURATION = 2.5
config.STATUS_CRYO_SLOW_MULT = 1.43
config.STATUS_CRYO_ICE_CHANCE = 0.15
config.STATUS_CRYO_GOLEM_RADIUS = 4
